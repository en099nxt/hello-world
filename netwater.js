...
//>>>>>	//【通用】of【留言板頁專用】---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	$('.pt9>select').css('padding-bottom','9px');																					//選單拉高比較整齊
...
//>>>>>	//【通用】of【消息頁專用】---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	//$('.pt9').css({'color':'rgb(41, 119, 210)','font-size':'20px','font-family':'微軟正黑體'})					//輸入欄位前文字樣式
...
//>>>>>	//【電腦版專用】of【消息頁專用】---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	if(!__Mobile_Style_NW__ && !__Product_Page_NW__){										//如果是電腦版
		...
		$('.right_td .p_c1,.right_td .p_c2,.right_td .p_c4,.right_td .p_c5,.right_td .p_c6').css('display','none');		//網站圖邊框隱藏
		$('.right_td .p_c3').css('background','url()');										//網站圖邊框隱藏
		$('.n_title>a').ready(function(){
			$('.n_title>a:hover').css({'text-decoration':'none !important','color':'rgb(41,119,210) !important'});					//消息標題樣式
		});
	}
//>>>>>	//【手機版專用】of【消息頁專用】---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	else if(__Mobile_Style_NW__ && !__Product_Page_NW__){										//如果是手機版
