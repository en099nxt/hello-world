...
//【商品頁專用】讀取商品詳細資料
if(__Product_Page_NW__){																		//判斷是否有商品頁才有的 .p_tiem 區塊存在
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//【電腦版專用】【非手機版專用】【非商品頁專用】焦點商品跑馬燈
if(!__Mobile_Style_NW__ && !__Product_Page_NW__){			//判斷是否沒有手機版 .percent100 存在　＆　沒有商品頁才有的 .p_tiem 區塊存在
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//【手機版專用】【非商品頁專用】橫幅、網站名稱設定
if(__Mobile_Style_NW__ && !__Product_Page_NW__){					//判斷是否有手機版 .percent100 存在　＆　沒有商品頁才有的 .p_tiem 區塊存在
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//【非商品頁專用】商品列表預覽圖的樣式
if(!__Product_Page_NW__){				//判斷是否沒有商品頁才有的 .p_tiem 區塊存在
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//【非商品頁專用】左邊商品分類選單最上方搜尋欄位與隱藏的搜尋按鈕
if(!__Product_Page_NW__){						//判斷是否沒有商品頁才有的 .p_tiem 區塊存在
	$('#kw').ready(function(){
		$('#kw').css('border','1px solid rgb(135,183,220)');
	});
	if(!__Mobile_Style_NW__){					//判斷是否沒有手機版 .percent100 存在 (如果是電腦版)
		$('#shbt').ready(function(){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//【電腦版專用】【非手機版專用】【非商品頁專用】左邊選單商品子分類背景
if(!__Mobile_Style_NW__ && !__Product_Page_NW__){					//判斷是否沒有手機版 .percent100 存在　＆　沒有商品頁才有的 .p_tiem 區塊存在
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//商品列表名稱上的次方字體大小修正
if(__Mobile_Style_NW__){					//判斷是否有手機版 .percent100 存在
	if(__Product_Page_NW__){				//判斷是否有商品頁才有的 .p_tiem 區塊存在
